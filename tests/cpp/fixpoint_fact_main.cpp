// Auto-generated main for fixpoint_fact
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "fixpoint-fact.cpp"

// Detect if fixpoint_fact_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(fixpoint_fact_module_init, arg);
        return 0;
