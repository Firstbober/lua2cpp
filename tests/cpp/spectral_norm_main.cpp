// Auto-generated main for spectral_norm
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "spectral-norm.cpp"

// Detect if spectral_norm_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(spectral_norm_module_init, arg);
        return 0;
