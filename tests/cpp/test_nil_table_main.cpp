// Auto-generated main for test_nil_table
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "test_nil_table.cpp"

// Detect if test_nil_table_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(test_nil_table_module_init, arg);
        return 0;
