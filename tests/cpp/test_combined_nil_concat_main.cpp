// Auto-generated main for test_combined_nil_concat
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "test_combined_nil_concat.cpp"

// Detect if test_combined_nil_concat_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(test_combined_nil_concat_module_init, arg);
        return 0;
