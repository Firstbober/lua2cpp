// Auto-generated main for test_concat_chain
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "test_concat_chain.cpp"

// Detect if test_concat_chain_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(test_concat_chain_module_init, arg);
        return 0;
