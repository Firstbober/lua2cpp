// Auto-generated main for test_ulnotop_basic
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "test_ulnotop_basic.cpp"

// Detect if test_ulnotop_basic_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(test_ulnotop_basic_module_init, arg);
        return 0;
