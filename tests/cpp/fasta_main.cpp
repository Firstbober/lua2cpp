...
luaValue _l2c__fasta_export(luaState* state);

int main(int argc, char* argv[]) {
    std::cout << "Testing transpiled fasta.lua..." << std::endl;
    ...
    // Call the transpiled fasta.lua module
    luaValue result = _l2c__fasta_export(&state);
