// Auto-generated main for fannkuch_redux
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "fannkuch-redux.cpp"

// Detect if fannkuch_redux_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(fannkuch_redux_module_init, arg);
        return 0;
