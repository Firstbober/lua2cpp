// Auto-generated main for k_nucleotide
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "k-nucleotide.cpp"

// Detect if k_nucleotide_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(k_nucleotide_module_init, arg);
        return 0;
