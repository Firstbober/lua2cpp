...
luaValue _l2c__k_nucleotide_export(luaState* state);

int main(int argc, char* argv[]) {
    std::cout << "Testing transpiled k-nucleotide.lua..." << std::endl;
    ...
    // Call the transpiled k-nucleotide.lua module
    luaValue result = _l2c__k_nucleotide_export(&state);
