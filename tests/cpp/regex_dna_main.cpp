// Auto-generated main for regex_dna
// Runtime is provided by the included .cpp file below
#include <iostream>
#include <exception>
// Include the .cpp directly (which includes the appropriate runtime)
#include "regex-dna.cpp"

// Detect if regex_dna_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(regex_dna_module_init, arg);
        return 0;
