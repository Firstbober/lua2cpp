...
luaValue _l2c__qt_export(luaState* state);

int main(int argc, char* argv[]) {
    std::cout << "Testing transpiled qt.lua..." << std::endl;
    ...
    // Call the transpiled qt.lua module
    luaValue result = _l2c__qt_export(&state);
