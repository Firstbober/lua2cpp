// Auto-generated main for binary_trees
...
// Detect if binary_trees_module_init takes a TABLE argument using SFINAE
...
int main(int argc, char* argv[]) {
    try {
        ...
        call_module_init(binary_trees_module_init, arg);
        return 0;
