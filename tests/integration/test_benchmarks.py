...
class TestIntegration:
    ...
    def test_spectral_norm_has_functions(self):
        ...
        # Check for expected function definitions (auto&& parameters)
        assert "auto&&" in cpp_code and "A(luaState" in cpp_code
        assert "auto&&" in cpp_code and "Av(luaState" in cpp_code
        assert "auto&&" in cpp_code and "Atv(luaState" in cpp_code
        assert "auto&&" in cpp_code and "AtAv(luaState" in cpp_code
    ...
    def test_simple_file_transpiles(self):
        ...
        cpp_code = transpile_file(input_file)
        assert cpp_code is not None
        assert "auto&&" in cpp_code and "add" in cpp_code
